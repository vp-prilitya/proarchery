            ...
            <div class="white shadow r-15">
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     ...
                     <div class="col-sm-3">
                        <div class="form-group">
                           <label for="no_faktur">No Penjualan (SO)</label>
                           <input type="text" class="form-control" placeholder="Masukan No Penjualan (SO)" id="no_faktur" name="no_faktur">
                        </div>
                     </div>
        ...
        <div class="row ml-1">
         ...
         <div class="white shadow r-15">
            ...
            <div class="row">
               ...
               <div class="col">
                  <a href="<?=base_url('pesanan_penjualan/create')?>" class="btn btn-primary btn-xs float-right mt-5 mr-5"><i class="icon-plus"></i> Tambah</a>
               </div>
            </div>
            <!-- </div> -->
            <div class="card-body">
                     ...
                     <?php $i=1; foreach($data as $db):?>
                        <tr>
                           ...
                           <td>
                              ...
                              <a target="_blank" href="<?=base_url('pesanan_penjualan/print/')?><?=$db['id']?>" class="btn btn-success btn-xs my-1"><i class="icon-edit"></i> Print</a>

                              <a href="<?=base_url('pesanan_penjualan/delete/')?><?=$db['id']?>" class="btn btn-danger btn-xs my-1 tombol-hapus"><i class="icon-trash"></i> Hapus</a>
                           </td>
                        </tr>
                     <?php endforeach?>
                  </tbody>
