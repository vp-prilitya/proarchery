            ...
            <div class="row">
                <div class="col-lg-4 mx-md-auto paper-card">
                    <div class="text-center">
                        ...
                        <p class="p-t-b-20">Welcome Back.. Please log in to access the application</p>
                    </div>
                    ...
                    <p class="text-center mt-1">Belum Memiliki Akun? Silahkan Daftar dibawah ini .. </p>
                    <a href="<?=base_url('auth_pelanggan/register')?>" class="btn btn-lg btn-block btn-social twitter">
                        Register
                    </a>
                </div>
            </div>
