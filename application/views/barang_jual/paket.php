        ...
        <div class="row ml-1">
         ...
         <div class="white shadow r-15">
            ...
            <div class="row">
               ...
               <div class="col">
                  <a href="<?=base_url('barang_jual/createPaket')?>" class="btn btn-primary btn-xs float-right mt-5 mr-5"><i class="icon-plus"></i> Tambah</a>
               </div>
            </div>
            <!-- </div> -->
            <div class="card-body">
                  ...
                  <tbody>
                     <?php $i=1; foreach($data as $db):?>
                        <tr>
                           ...
                           <td><?=$db['nama']?></td>
                           <td><?=number_format($db['harga_pokok']==''?'-':$db['harga_pokok'],0,'',',')?></td>
                           <td><?=number_format($db['harga_jual'],0,'',',')?></td>
                           <td><?=$db['min_stok']?></td>
                           <td><?=$db['stok']?></td>
                           <!-- <td><?=$db['need_raw']==0?'Tidak' : 'Ya'?></td>
                           <td><?=$db['is_paket']==0?'Tidak' : 'Ya'?></td> -->
                           <td>
                              <a href="<?=base_url('barang_jual/editPaket/')?><?=$db['id']?>" class="btn btn-warning btn-xs my-1"><i class="icon-edit"></i> Ubah</a>
                              <a href="<?=base_url('barang_jual/delete/')?><?=$db['id']?>" class="btn btn-danger btn-xs my-1 tombol-hapus" ><i class="icon-delete_forever"></i> Hapus</a>
                           </td>
                        </tr>
                     <?php endforeach?>
                  </tbody>
