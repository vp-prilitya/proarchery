<div class="container-fluid animatedParent animateOnce my-3">
        ...
        <div class="row ml-1">
            ...
            <form action="<?=base_url('barang_jual/savePaket')?>" method="post" enctype="multipart/form-data">
            <div class="row mb-3">
               <div class="col-sm-12">
                              ...
                              <!-- <div class="row">
                                 ...
                                 <div class="col-sm mt-4">
                                    <div class="material-switch mt-1" style="margin-left:-60px;">
                                       <input id="jadwal" name="jadwal" type="checkbox" value="1"/>
                           ...
                           <table id="example2" class="table table-bordered table-striped table-hover data-tables" data-options='{"paging":false}'>
                              ...
                              <tbody>
                                 <!-- <tr>
                                    ...
                                    <td>1</td>
                                    <td>
                                       <input type="text" class="form-control" id="quantityBarangJualid" name="quantityBarangJual[]" required>
                                       <input type="hidden" class="form-control" id="idBarangJualid" name="idBarangJual[]" required>
                                    </td>
                                    <td>
               ...
               <div class="col-sm-12">
                  <div class="white shadow r-15">
                     <div class="card-body text-right">
                        <a href="<?=base_url('barang_jual/paket')?>" class="btn btn-danger mr-2">Batal</a>
      ...
      $( "#barang_jual_id" ).change(function() {
         ...
         $.ajax({
                ...
                success:function(data){
                     var quantity = `<input type="text" class="form-control" id="quantityBarangJualid`+data.id+`" name="quantityBarangJual[]" required onkeyup="qty(`+data.id+`, this.value)" value="1">
