<div class="container-fluid animatedParent animateOnce my-3">
        ...
        <form action="<?=base_url('penawaran_penjualan/save')?>" method="post">
                  ...
                  <div class="form-group">
                     ...
                     <select class="custom-select select2" name="barang_jual_id" id="barang_jual_id">
                        ...
                        <?php foreach($produk as $db):?>
                           <option value="<?=$db['id']?>" data-raw=0 data-paket=><?=$db['nama']?> - <?=$db['no_part']?> | <?=$db['satuan']?> | Stok <?=$db['stok']?> | Harga <?=number_format($db['harga_pokok'],0,'','.')?></option>
                        <?php endforeach?>
                        ...
                        <div class="table-responsive">
                           <table class="table">
                              ...
                              <tr>
                                 ...
                                 <td>
                                 <input type="text" name="total_tagihan" id="total_tagihan" class="form-control" readonly value=0 />
                                 </td>
                              </tr>
                              <!-- <tr>
