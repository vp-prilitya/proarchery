            ...
            <div class="white shadow r-15">
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     ...
                     <div class="col-sm-3">
                        <div class="form-group">
                           <label for="no_faktur">No Quotation</label>
                           <input type="text" class="form-control" placeholder="Masukan No Quotation" id="no_faktur" name="no_faktur">
                        </div>
                     </div>
        ...
        <div class="row ml-1">
         ...
         <div class="white shadow r-15">
            ...
            <div class="row">
               ...
               <div class="col">
                  <a href="<?=base_url('penawaran_penjualan/create')?>" class="btn btn-primary btn-xs float-right mt-5 mr-5"><i class="icon-plus"></i> Tambah</a>
               </div>
            </div>
            <!-- </div> -->
            <div class="card-body">
                  ...
                  <tbody>
                     <?php $i=1; foreach($data as $db):?>
                        <tr>
                           ...
                           <td><?=number_format($db['ppn'],0,'',',')?></td>
                           <td><?=ucwords($db['jenis_ppn'])?></td>
                           <td><?=$db['created']?></td>
                           <td>
                              <!-- <a href="<?=base_url('penjualan/edit/')?><?=$db['id']?>" class="btn btn-warning btn-xs"><i class="icon-edit"></i> Ubah</a> -->
                              <a target="_blank" href="<?=base_url('penawaran_penjualan/print/')?><?=$db['id']?>" class="btn btn-success btn-xs"><i class="icon-edit"></i> Print</a>

                              <a href="<?=base_url('penawaran_penjualan/delete/')?><?=$db['id']?>" class="btn btn-danger btn-xs tombol-hapus"><i class="icon-trash"></i> Hapus</a>
                           </td>
                        </tr>
                     <?php endforeach?>
                  </tbody>
