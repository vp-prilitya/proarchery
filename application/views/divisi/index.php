                  ...
                  <tbody>
                     <?php $i=1; foreach($data as $db):?>
                        <tr>
                           ...
                           <td><?=$db['nama']?></td>
                           <td>
                              <a href="<?=base_url('divisi/edit/')?><?=$db['id']?>" class="btn btn-warning btn-xs"><i class="icon-edit"></i> Ubah</a>
                              <?php if($db['id'] != 6):?>
                              <a href="<?=base_url('divisi/delete/')?><?=$db['id']?>" class="btn btn-danger btn-xs tombol-hapus" ><i class="icon-delete_forever"></i> Hapus</a>
                              <?php endif?>
                           </td>
                        </tr>
                     <?php endforeach?>
