                  ...
                  <div class="row">
                     <div class="col-12">
                           ...
                           <div class="float-right">
                              <h4><strong>No Pembelian #<?=$data[0]['no_faktur']?></strong></h4><br>
                              <table>
                                 <tr>
                                 ...
                                 <tr>
                                    <td class="font-weight-normal">No Pembelian :</td>
                    ...
                    <div class="col-12 table-responsive">
                      <table class="table table-striped">
                        ...
                        <?php $i=1; foreach($data as $db) :?>
                          <tr>
                            <td><?=$i++?></td>
                            <td><?=$db['item_jual']??$db['item_mentah']?></td>
                            <td>IDR <?=number_format($db['harga'],0,'','.')?></td>
                            <td><?=$db['quantity']?> <?=$db['satuan_jual']??$db['satuan_mentah']?></td>
                            <td><?=$db['disc']?></td>
