<div class="container-fluid animatedParent animateOnce my-3">
        ...
        <form action="<?=base_url('penawaran_pembelian/save')?>" method="post">
               ...
               <div class="card-body">
                  <div class="form-group">
                     ...
                     <?php foreach($paket as $db):?>
                        <option value="<?=$db['id']?>" data-raw=1 data-paket=0><?=$db['nama']?> - <?=$db['no_part']?> | <?=$db['satuan']?> | Stok <?=$db['stok']?> | Harga <?=number_format($db['harga_pokok'],0,'','.')?></option>
                     <?php endforeach?>
                  </select>
                  </div>
               </div>
