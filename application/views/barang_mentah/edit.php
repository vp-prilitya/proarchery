         ...
         <div class="row">
            <div class="col-sm-12">
               <div class="white shadow r-15">
                  ...
                  <form action="<?=base_url('barang_mentah/update')?>" method="post">
                  ...
                  <div class="row">
                     ...
                     <div class="col-sm-6">
                        <div class="form-group">
                           ...
                           <input type="number" class="form-control" placeholder="Masukan Stok Awal" id="stok" name="stok"  value="<?=$data['stok']?>">
                        </div>

                        <div class="form-group">
                           <label for="min_stok">Minimal Stok</label>
                           <input type="number" class="form-control" placeholder="Masukan Minimal Stok" id="min_stok" name="min_stok"  value="<?=$data['min_stok']?>">
                        </div>
               ...
               <div class="white shadow r-15">
                  <div class="card-body">
                     <div class="text-right">
                              <a href="<?=base_url('barang_mentah')?>" class="btn btn-danger mr-2">Batal</a>
