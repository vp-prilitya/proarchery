               ...
               <table id="example2" class="table table-condensed table-bordered table-striped ">
                  ...
                  <tbody>
                     ...
                     <?php $no=1; foreach($harta as $key => $db):?>
                        ...
                        <?php $mutasi = $debit-$kredit; $totalDebit += $debit; $totalKredit += $kredit;
                              $mutasi > 0 ? $totalDebitAkhir += $mutasi : null;   
                              $mutasi < 0 ? $totalKreditAkhir += abs($mutasi) : null;   
                        ?>
                        <?php if($akun[2] !== '') : ?>
                           <tr class="collapse1" id="harta<?=$collapse?>">
                              <td></td>
                              <td><?=$akun[0]?></td>
                        ...
                        <?php else :?>
                           <?php $collapse = $no++;?>
                           <tr data-toggle="collapse1" data-target="#harta<?=$collapse?>">
                              <td>
                     ...
                     <?php $no=1; foreach($utang as $key => $db):?>
                        ...
                        ?>
                        <?php if($akun[2] !== '') : ?>
                           <tr class="collapse1" id="utang<?=$collapse?>">
                              <td></td>
                              <td><?=$akun[0]?></td>
                              <td><strong><?=$akun[1]?></strong></td>
                              <td><?=number_format($debit, 0, '', ',')?></td>
                        ...
                        <?php else :?>
                           <?php $collapse = $no++;?>
                           <tr data-toggle="collapse1" data-target="#utang<?=$collapse?>">
                              <td>
                                 <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="<?=$akun[0]?>" name="akun_id[]" id="akun<?=$akun[0]?>" checked>
                                 </div>
                     ...
                     <?php $no=1; foreach($modal as $key => $db):?>
                        ...
                        ?>
                        <?php if($akun[2] !== '') : ?>
                           <tr class="collapse1" id="modal<?=$collapse?>">
                              <td></td>
                              <td><?=$akun[0]?></td>
                              <td><strong><?=$akun[1]?></strong></td>
                              <td><?=number_format($debit, 0, '', ',')?></td>
                        ...
                        <?php else :?>
                           <?php $collapse = $no++;?>
                           <tr data-toggle="collapse1" data-target="#modal<?=$collapse?>">
                              <td>
                                 <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="<?=$akun[0]?>" name="akun_id[]" id="akun<?=$akun[0]?>" checked>
                                 </div>
                     ...
                     <?php $no=1; foreach($pendapatan as $key => $db):?>
                        ...
                        ?>
                        <?php if($akun[2] !== '') : ?>
                           <tr class="collapse1" id="pendapatan<?=$collapse?>">
                              <td></td>
                              <td><?=$akun[0]?></td>
                              <td><strong><?=$akun[1]?></strong></td>
                              <td><?=number_format($debit, 0, '', ',')?></td>
                        ...
                        <?php else :?>
                           <?php $collapse = $no++;?>
                           <tr data-toggle="collapse1" data-target="#pendapatan<?=$collapse?>">
                              <td>
                                 <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="<?=$akun[0]?>" name="akun_id[]" id="akun<?=$akun[0]?>" checked>
                                 </div>
                     ...
                     <?php $no=1; foreach($beban as $key => $db):?>
                        ...
                        ?>
                        <?php if($akun[2] !== '') : ?>
                           <tr class="collapse1" id="beban<?=$collapse?>">
                              <td></td>
                              <td><?=$akun[0]?></td>
                              <td><strong><?=$akun[1]?></strong></td>
                              <td><?=number_format($debit, 0, '', ',')?></td>
                        ...
                        <?php else :?>
                           <?php $collapse = $no++;?>
                           <tr data-toggle="collapse1" data-target="#beban<?=$collapse?>">
                              <td>
                                 <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="<?=$akun[0]?>" name="akun_id[]" id="akun<?=$akun[0]?>" checked>
                                 </div>
                     ...
                     <?php $no=1; foreach($beban_umum as $key => $db):?>
                        ...
                        ?>
                        <?php if($akun[2] !== '') : ?>
                           <tr class="collapse1" id="beban_umum<?=$collapse?>">
                              <td></td>
                              <td><?=$akun[0]?></td>
                              <td><strong><?=$akun[1]?></strong></td>
                              <td><?=number_format($debit, 0, '', ',')?></td>
                        ...
                        <?php else :?>
                           <?php $collapse = $no++;?>
                           <tr data-toggle="collapse1" data-target="#beban_umum<?=$collapse?>">
                              <td>
                                 <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="<?=$akun[0]?>" name="akun_id[]" id="akun<?=$akun[0]?>" checked>
                                 </div>
                     ...
                     <?php $no=1; foreach($pendapatan_lain as $key => $db):?>
                        ...
                        ?>
                        <?php if($akun[2] !== '') : ?>
                           <tr class="collapse1" id="pendapatan_lain<?=$collapse?>">
                              <td></td>
                              <td><?=$akun[0]?></td>
                              <td><strong><?=$akun[1]?></strong></td>
                              <td><?=number_format($debit, 0, '', ',')?></td>
                        ...
                        <?php else :?>
                           <?php $collapse = $no++;?>
                           <tr data-toggle="collapse1" data-target="#pendapatan_lain<?=$collapse?>">
                              <td>
                                 <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="<?=$akun[0]?>" name="akun_id[]" id="akun<?=$akun[0]?>" checked>
                                 </div>
                     ...
                     <?php $no=1; foreach($beban_lain as $key => $db):?>
                        ...
                        ?>
                        <?php if($akun[2] !== '') : ?>
                           <tr class="collapse1" id="beban_lain<?=$collapse?>">
                              <td></td>
                              <td><?=$akun[0]?></td>
                              <td><strong><?=$akun[1]?></strong></td>
                              <td><?=number_format($debit, 0, '', ',')?></td>
                        ...
                        <?php else :?>
                           <?php $collapse = $no++;?>
                           <tr data-toggle="collapse1" data-target="#beban_lain<?=$collapse?>">
                              <td>
                                 <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="<?=$akun[0]?>" name="akun_id[]" id="akun<?=$akun[0]?>" checked>
                                 </div>
