...
<aside class="main-sidebar fixed offcanvas shadow bg-primary text-white no-b">
    <section class="sidebar">
        ...
        <ul class="sidebar-menu hover-dark">
            ...
            <li class=""><a href="<?=base_url('kuota')?>"><img src="<?=base_url()?>assets/img/icon/dashboardw.png" class="img-icon">Kuota</a></li>
            <li class=""><a href="<?=base_url('booking')?>"><img src="<?=base_url()?>assets/img/icon/dashboardw.png" class="img-icon">Booking</a></li>
            ...
            <ul class="dropdown-menu dropdown-menu-right r-15">
                ...
                <li>
                    ...
                    <ul class="menu">
                        ...
                        <li>
                            <a href="javascript:void(0)">
                            <img src="<?=base_url()?>assets/img/icon/divisi.png" class="img-icon"><?=$this->session->userdata('nama')?>
                            </a>
                        </li>
                    </ul>
                </li>
                <li class="footer p-2 text-center bg-danger text-white" style="border-radius: 0px 0px 15px 15px;"><a href="<?=base_url('auth_pelanggan/logout')?>"><i class="icon icon-sign-out"></i>Log Out</a></li>
            </ul>
        </li>
    </ul>
</div>
