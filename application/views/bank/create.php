            ...
            <div class="row">
               <div class="col-sm-6">
                  <div class="white shadow r-15">
                     ...
                     <form action="<?=base_url('bank/save')?>" method="post">
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" placeholder="Masukan Nomor Rekening" id="no_rek" name="no_rek" required>
                        </div>

                        <div class="form-group">
                           <label for="nama_pemilik">Nama Pemilik</label>
                           <input type="text" class="form-control" placeholder="Masukan Nama Pemilik" id="nama_pemilik" name="nama_pemilik" required>
                        </div>
