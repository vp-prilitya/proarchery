            ...
            <div class="row">
               <div class="col-sm-6">
                  <div class="white shadow r-15">
                     ...
                     <form action="<?=base_url('uang_muka_pembelian/update')?>" method="post">
                     <input type="hidden" id="id" name="id" value="<?=$data['id']?>" required>
                        <div class="form-group">
                           ...
                           <select class="custom-select select2" name="vendor_id" id="vendor_id" required>
                              ...
                              <?php foreach($pelanggan as $db):?>
                                 <option value="<?=$db['id']?>" <?=$data['vendor_id']==$db['id']?'selected':''?>><?=$db['nama']?> || <?=$db['telp']?></option>
                              <?php endforeach?>
                           </select>
                        </div>
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" placeholder="Masukan ppn" id="ppn" name="ppn" required value="<?=number_format($data['ppn'],2,',','.')?>" readonly>
                        </div>
