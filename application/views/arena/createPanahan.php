            ...
            <div class="row">
               <div class="col-sm-6">
                  <div class="white shadow r-15">
                     ...
                     <form action="<?=base_url('arena/savePanahan')?>" method="post">
                        ...
                        <div class="form-group">
                           ...
                           <input type="number" class="form-control" placeholder="Masukan Jumlah Bantalan" id="jumlah" name="jumlah" required>
                        </div>

                        <div class="form-group">
                           <label for="kapasitas">Kapasitas / Bantalan</label>
                           <input type="number" class="form-control" placeholder="Masukan Kapasitas / Bantalan" id="kapasitas" name="kapasitas" required>
                        </div>

                        <div class="form-group">
                           <label for="kapasitas_maks">Kapasitas Maks</label>
                           <input type="number" class="form-control" placeholder="Masukan Kapasitas Maks" id="kapasitas_maks" name="kapasitas_maks" required readonly>
                        </div>
