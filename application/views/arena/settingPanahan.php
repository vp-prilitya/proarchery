                        ...
                        <tbody>
                           <?php $i=1; foreach($tanggal as $db):?>
                              <tr>
                                 ...
                                 <td><?=$db['tanggal']?></td>
                                 <td>
                                    <a href="<?=base_url('arena/deleteTanggalPanahan/')?><?=$db['id']?>/<?=$data['id']?>" class="btn btn-danger btn-xs tombol-hapus" ><i class="icon-delete_forever"></i> Hapus</a>
                                 </td>
                              </tr>
                           <?php endforeach?>
                        </tbody>
                        ...
                        <tbody>
                           <?php $i=1; foreach($jam as $db):?>
                              <tr>
                                 ...
                                 <td><?=$db['jam']?></td>
                                 <td>
                                    <a href="<?=base_url('arena/deleteJamPanahan/')?><?=$db['id']?>/<?=$data['id']?>" class="btn btn-danger btn-xs tombol-hapus" ><i class="icon-delete_forever"></i> Hapus</a>
                                 </td>
                              </tr>
                           <?php endforeach?>
                        </tbody>
...
<div class="modal fade bd-example-modal-lg" id="exampleModalTanggal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form action="<?=base_url('arena/saveTanggalPanahan')?>" method="post" enctype="multipart/form-data">
...
<div class="modal fade bd-example-modal-lg" id="exampleModalJam" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form action="<?=base_url('arena/saveJamPanahan')?>" method="post" enctype="multipart/form-data">
      <div class="modal-body">
         <div class="form-group">
