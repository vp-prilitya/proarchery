        ...
        <div class="row ml-1">
         ...
         <div class="white shadow r-15">
            ...
            <div class="row">
               ...
               <div class="col">
                  <a href="<?=base_url('hutang/create')?>" class="btn btn-primary btn-xs float-right mt-5 mr-5"><i class="icon-plus"></i> Tambah</a>
               </div>
            </div>
            <!-- </div> -->
            <div class="card-body">
                  ...
                  <tbody>
                     <?php $i=1; foreach($data as $db):?>
                        <tr>
                           ...
                           <td><?=$db['created']?></td>
                           <td>
                              <!-- <a href="<?=base_url('hutang/edit/')?><?=$db['id']?>" class="btn btn-warning btn-xs"><i class="icon-edit"></i> Ubah</a> -->
                              <!-- <a href="<?=base_url('hutang/bayar/')?><?=$db['id']?>" class="btn btn-warning btn-xs"><i class="icon-edit"></i> Detail</a> -->
                              <!-- <a href="<?=base_url('hutang/delete/')?><?=$db['id']?>" class="btn btn-danger btn-xs tombol-hapus" ><i class="icon-delete_forever"></i> Hapus</a> -->

                              <a target="_blank" href="<?=base_url('hutang/print/')?><?=$db['id']?>" class="btn btn-success btn-xs"><i class="icon-edit"></i> Print</a>
